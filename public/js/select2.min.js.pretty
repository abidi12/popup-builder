! function(e) {
    ...
    var t = function() {
            if (e && e.fn && e.fn.sgpbselect2 && e.fn.sgpbselect2.amd) var t = e.fn.sgpbselect2.amd;
            var n, i, o, s;
            return t && t.requirejs || (t ? o = t : t = {}, function(e) {
                ...
                function n(e, t) {
                    var n, i, o, s, r, a, l, c, u, d, p, h = t && t.split("/"),
                        ...
                        g = f && f["*"] || {};
                    if (e) {
                        for (r = (e = e.split("/")).length - 1, v.nodeIdCompat && $.test(e[r]) && (e[r] = e[r].replace($, "")), "." === e[0].charAt(0) && h && (e = h.slice(0, h.length - 1).concat(e)), u = 0; u < e.length; u++)
                ...
                function l(n) {
                    if (t(m, n)) {
                        var i = m[n];
                        delete m[n], y[n] = !0, d.apply(e, i)
                    }
                    if (!t(g, n) && !t(y, n)) throw new Error("No " + n);
                    return g[n]
                }
                ...
                h = function(e, t) {
                    var i, o, s = c(e),
                        r = s[0],
                        a = t[1];
                    return e = s[1], r && (i = l(r = n(r, a))), r ? e = i && i.normalize ? i.normalize(e, (o = a, function(e) {
                        return n(e, o)
                    })) : n(e, a) : (r = (s = c(e = n(e, a)))[0], e = s[1], r && (i = l(r))), {
                        f: r ? r + "!" + e : e,
                        n: e,
                        pr: r,
                        p: i
                    ...
                    var c, d, p, v, w, _, $, b = [],
                        x = typeof o;
                    if (_ = u(s = s || n), "undefined" === x || "function" === x) {
                        for (i = !i.length && o.length ? ["require", "exports", "module"] : i, w = 0; w < i.length; w += 1)
                            if ("require" === (d = (v = h(i[w], _)).f)) b[w] = f.require(n);
                            else if ("exports" === d) b[w] = f.exports(n), $ = !0;
                        else if ("module" === d) c = b[w] = f.module(n);
                        else if (t(g, d) || t(m, d) || t(y, d)) b[w] = l(d);
                        else {
                            if (!v.p) throw new Error(n + " missing " + d);
                            v.p.load(v.n, r(s, !0), a(d), {}), b[w] = g[d]
                        }
                        p = o ? o.apply(g[n], b) : void 0, n && (c && c.exports !== e && c.exports !== g[n] ? g[n] = c.exports : p === e && $ || (g[n] = p))
                    } else n && (g[n] = o)
                }, i = o = p = function(t, n, i, o, s) {
                    if ("string" == typeof t) return f[t] ? f[t](n) : l(h(t, u(n)).f);
                    if (!t.splice) {
                    ...
                    return p(e)
                }, i._defined = g, (s = function(e, n, i) {
                    if ("string" != typeof e) throw new Error("See almond README: incorrect module build, no module name");
                    n.splice || (i = n, n = []), t(g, e) || t(m, e) || (m[e] = [e, n, i])
                }).amd = {
                    jQuery: !0
                }
                ...
                return t.Extend(i, t.Observable), i.prototype.render = function() {
                    ...
                    e(document.body).on("mousedown.select2." + t.id, function(t) {
                        ...
                        e(".select2.select2-container--open").each(function() {
                            var t = e(this);
                            this != n[0] && t.data("element").sgpbselect2("close")
                        })
                    })
                ...
                return i.prototype.render = function(t) {
                    ...
                    var e;
                    this.$search.css("width", "25px"), e = "" !== this.$search.attr("placeholder") ? this.$selection.find(".select2-selection__rendered").innerWidth() : .75 * (this.$search.val().length + 1) + "em", this.$search.css("width", e)
                }, i
                ...
                return t.prototype.query = function(e, t, n) {
                    ...
                    this._removeOldTags(), null != t.term && null == t.page ? e.call(this, t, function e(o, s) {
                        ...
                        if (null != u) {
                            var d = i.option(u);
                            d.attr("data-select2-tag", !0), i.addOptions([d]), i.insertTag(r, u)
                        }
                        o.results = r, n(o)
                    }) : e.call(this, t, n)
            ...
            }), t.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function(e, t, n, i, o, s, r, a, l, c, u, d, p, h, f, g, m, v, y, w, _, $, b, x, A, C, S, O, E) {
                function D() {
                    this.reset()
                }
                    ...
                    this.defaults = {
                        ...
                        matcher: function n(i, o) {
                            ...
                            if (o.children && o.children.length > 0) {
                                for (var s = e.extend(!0, {}, o), r = o.children.length - 1; r >= 0; r--) null == n(i, o.children[r]) && s.children.splice(r, 1);
                ...
                return o.prototype.fromElement = function(e) {
                    ...
                    var s = t.extend(!0, {}, n);
                    for (var r in s = i._convertData(s)) t.inArray(r, o) > -1 || (t.isPlainObject(this.options[r]) ? t.extend(this.options[r], s[r]) : this.options[r] = s[r]);
                    return this
                ...
                function t(t) {
                    var r = t || window.event,
                        ...
                        f = 0,
                        g = 0;
                    if ((t = e.event.fix(r)).type = "mousewheel", "detail" in r && (p = -1 * r.detail), "wheelDelta" in r && (p = r.wheelDelta), "wheelDeltaY" in r && (p = r.wheelDeltaY), "wheelDeltaX" in r && (d = -1 * r.wheelDeltaX), "axis" in r && r.axis === r.HORIZONTAL_AXIS && (d = -1 * p, p = 0), c = 0 === p ? d : p, "deltaY" in r && (c = p = -1 * r.deltaY), "deltaX" in r && (d = r.deltaX, 0 === p && (c = -1 * d)), 0 !== p || 0 !== d) {
                        if (1 === r.deltaMode) {
                        ...
                        if (h = Math.max(Math.abs(p), Math.abs(d)), (!s || h < s) && (s = h, i(r, h) && (s /= 40)), i(r, h) && (c /= 40, d /= 40, p /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / s), d = Math[d >= 1 ? "floor" : "ceil"](d / s), p = Math[p >= 1 ? "floor" : "ceil"](p / s), u.settings.normalizeOffset && this.getBoundingClientRect) {
                            var y = this.getBoundingClientRect();
                            f = t.clientX - y.left, g = t.clientY - y.top
                        }
                        return t.deltaX = d, t.deltaY = p, t.deltaFactor = s, t.offsetX = f, t.offsetY = g, t.deltaMode = 0, a.unshift(t, c, d, p), o && clearTimeout(o), o = setTimeout(n, 200), (e.event.dispatch || e.event.handle).apply(this, a)
                    }
                }
                ...
                if (null == e.fn.sgpbselect2) {
                    var o = ["open", "close", "destroy"];
                    e.fn.sgpbselect2 = function(t) {
                ...
                return null == e.fn.sgpbselect2.defaults && (e.fn.sgpbselect2.defaults = i), n
            }), {
                define: t.define,
                require: t.require
            }
    ...
    return e.fn.sgpbselect2.amd = t, n
});